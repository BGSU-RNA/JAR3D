...
function [S,IDI] = pIsoScore(Class,Code1,Code2,method,ExemplarIDI,ExemplarFreq,Normalize)
...
elseif Class == 0,
  ...
  switch method
    case 1,  S = pIsoScore1(Class,Code1,Code2,Normalize);
    case 2,  [S,IDI] = pIsoScore2(Class,Code1,Code2,ExemplarIDI,Normalize);
    case 3,  S = pIsoScore3(Class,Code1,Code2,ExemplarIDI,ExemplarFreq,Normalize);
    case 4,  S = pIsoScore4(Class,Code1,Code2,ExemplarIDI,Normalize);
